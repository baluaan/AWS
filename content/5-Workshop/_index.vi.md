...
4. [Khởi tạo máy chủ EC2 Ubuntu & Cấu hình](5.4-Launch-EC2-Ubuntu/)
5. [Cấu hình CloudWatch Agent ](5.5-Configure-CloudWatch/)
6. [Khởi tạo Amazon Topic Amazon SNS](5.6-Create-SNS/)
7. [Khởi tạo tự động chặn IP](5.7-Create-Automation/)
8. [Kiểm thử hệ thống ](5.8-Testing-Automation/)
